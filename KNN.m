...
Mdl = fitcknn(train_data1,class_data,'NumNeighbors',3,...
    'NSMethod','exhaustive','Distance','chebychev',...
    'Standardize',1);

[label,score,cost] = predict(Mdl,PC2);
 Re= reshape(label,[3700,9000]);
 
 
test_image1=single(zeros(3700,9000,3));
test1 = Re;
cluster1_1=single(255*(test1 == 1)); %Sea

cluster1_2 = single(255*(test1 == 2)); %forest
cluster1_3 = single(255*(test1 == 3)); %City
cluster1_4 = single(255*(test1 == 4)); %Ground
